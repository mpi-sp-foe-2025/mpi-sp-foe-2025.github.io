...
(** (As in Coq, a two-argument function in the
...
(** _Technical note_: Substitution would also become trickier to define if
    one were to consider the case where [s], the term being substituted for a
